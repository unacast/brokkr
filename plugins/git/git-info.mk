...
_git.buildinfo:
	...
	echo sha1=$(GIT_SHA1) >> $(BUILD_INFO_PATH)
	echo sha1_short=$(GIT_SHA1_SHORT) >> $(BUILD_INFO_PATH)
	echo branch=$(GIT_BRANCH) >> $(BUILD_INFO_PATH)
	echo author=$(GIT_AUTHOR) >> $(BUILD_INFO_PATH)
